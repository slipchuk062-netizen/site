      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-emerald-50 rounded-lg border border-emerald-200">
          <p className="text-sm text-slate-700">
            <strong className="text-emerald-700">📊 Метод ліктя:</strong> Графік показує зменшення інерції (WCSS) зі збільшенням кількості кластерів. 
            "Лікоть" на K=7 вказує на оптимальну кількість кластерів для даного датасету.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
          <p className="text-sm text-slate-700">
            <strong className="text-blue-700">📈 Silhouette Plot:</strong> Показує наскільки добре кожен об'єкт вписується у свій кластер. 
            Значення близько +1 означає, що об'єкт добре кластеризований. Значення близько -1 означає неправильне присвоєння.
          </p>
        </div>
      </div>
    );
    ...
    <section className="py-20 bg-gradient-to-b from-white to-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <Badge className="mb-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-lg px-6 py-2">
            <Activity className="h-5 w-5 mr-2 inline" />
            Наукова аналітика кластеризації
          </Badge>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-slate-900 via-blue-800 to-purple-800 bg-clip-text text-transparent">
            Методи оптимізації та оцінки
          </h2>
        </div>
